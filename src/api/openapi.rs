...
use crate::{
    ...
    api::catalog::{
        ...
        ArtistAlbumGroup, ArtistBrowseItem, ArtistDetailHeader, ArtistDetailLink,
        ArtistDetailMetadata, ArtistDetailResponse, ArtistDetailSummary, ArtistExternalLink,
        ArtistTrackGroup, BrowseAlbumsResponse, BrowseArtistsResponse, BrowseEpisodesResponse,
        BrowsePodcastsResponse, BrowseTracksResponse, CatalogBrowsePageMetadata,
        CatalogBrowseQuery, CatalogSearchQuery, CatalogSearchResponse, DetailTrackItem,
        EpisodeResponse, EpisodeResumeResponse, PodcastResponse, SearchTrackEntry,
    },
    api::config::{
    ...
    api::playback::{
        ...
        PlaybackSessionAttachRequest, PlaybackSessionQueueReplaceRequest,
        PlaybackSessionStatePatchRequest, PlaybackSessionTransferConfirmRequest,
    ...
    api::sonos::{
        SonosGroupTarget, SonosMuteRequest, SonosNextItemSummary, SonosPlaybackResponse,
        SonosPlaybackTarget, SonosPlayRequest, SonosPlaySourceType, SonosSeekRequest,
        SonosSessionSummary, SonosSpeakerTarget, SonosTargetsResponse, SonosVolumeRequest,
    },
    api::startup::{
    ...
    domain::{
        ...
        PlaylistScope, Podcast, PodcastCatalogGrouping, ProviderHealth, ProviderKind,
        ProviderSetting, ProviderStatus, QuarantineItem, QuarantineReason, QuarantineStatus,
        RepairPlan, SonosDeliveryKind, SonosSessionStatus, SonosSignedClaim,
        SonosTransportState, SystemConfig, Track, TrackFavorite, TranscodeSlotUsage,
        UserAccount,
    },
    ...
    state::{
        ...
        PlaybackHistoryScreenPatch, PlaybackProgressScreenPatch, PlaybackSessionAttachment,
        PlaybackSessionQueueItem, PlaybackSessionReadModel, PlaybackSessionReplacedPatch,
        PlaybackSessionTarget, PlaybackSessionTransfer, PlaylistDetailRemovePatch,
...
#[openapi(
    paths(
        ...
        crate::api::playback::get_session,
        crate::api::playback::attach_session,
        crate::api::playback::detach_session,
        crate::api::playback::replace_session_queue,
        crate::api::playback::update_session_state,
        crate::api::playback::request_session_transfer,
        crate::api::playback::confirm_session_transfer,
        ...
        crate::api::sonos::set_target_volume,
        crate::api::sonos::set_target_mute,
    ...
    tags(
        ...
        (name = "playback", description = "User-scoped shared playback session, transfer, progress, and history"),
...
fn apply_contract_schema_overrides(openapi: &mut utoipa::openapi::OpenApi) {
    ...
    for (schema_name, field_name) in [
        ...
        ("PlaybackSessionReadModel", "context_type"),
        ("PlaybackSessionReadModel", "context_id"),
        ("PlaybackSessionReadModel", "current_index"),
        ("PlaybackSessionReadModel", "duration_seconds"),
        ("PlaybackSessionReadModel", "attachment"),
        ("PlaybackSessionReadModel", "transfer"),
        ("PlaybackSessionQueueItem", "duration_seconds"),
        ("PlaybackSessionAttachment", "device_id"),
        ("PlaybackSessionAttachment", "device_name"),
        ("PlaybackSessionAttachment", "app_instance_id"),
        ("PlaybackSessionTransfer", "confirmed_target"),
        ("PlaybackSessionTransfer", "confirmed_at"),
        ("PlaybackSessionTransfer", "failure_reason"),
    ] {
